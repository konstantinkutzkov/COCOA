 ...
 *   - opt-in pool / dynamic-subsumption analyzers (analyze* family),
 *   - order-sensitivity bisection knobs (permute* / sort* family),
...
// ---------------------------------------------------------------------
// Pool analysis: scan the LEARNED clause pool for duplicates and
// subsumption opportunities. Read-only.
// ---------------------------------------------------------------------
